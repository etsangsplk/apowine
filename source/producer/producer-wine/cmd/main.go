...
import (
	...
	"github.com/aporeto-inc/apowine/source/producer/producer-wine"
	"github.com/aporeto-inc/apowine/source/producer/producer-wine/configuration"
...
func main() {
	...
	err = producerwine.PushWinesToDB(cfg.ServerURI)
	if err != nil {
